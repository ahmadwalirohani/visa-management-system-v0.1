...
function AddBank() {
    ...
    const [useFormFields, setFormFields] = useState<IBankFormFields>({
        name: "",
        phone: "",
        address: "",
        email: "",
    ...
    const onSubmit = (e: FormEvent<HTMLFormElement>) => {
        ...
        ValidateCustomForm(useFormFields, ["name", "code", "phone", "address"])
            .then((validated): any => {
                ...
                const Config = SendActionRequest(
                    {
                        ...
                        _method_name: "add_bank",
                        _validation_class: "CreateBank",
                    },
                    Object.assign(
                        {},
                        { ...useFormFields },
                ...
                axiosInstance
                    ...
                    .then((Response: AxiosResponse<any>): any => {
                        ...
                        setSnackbar({
                            msg: "بانک / صرافي په بریالي سره ثبت سول",
                            state: "success",
                            is_open: true,
                        });
                        ...
                        emitEvent("ReloadBanksEvent", true);
    ...
    useEffect(() => {
        ...
        GetBankLatestID(function (id: number | null | string | boolean): void {
            setFormFields((prevState) => ({
                ...prevState,
                code: `T-${id}`,
            }));
    ...
    return (
        <Grid xl={3} md={3} sm={12}>
            ...
            >
                ...
                <InputField
                    placeHolder="بانک / صرافي ادرس *"
                    name="address"
                    type="text"
                    readonly={false}
                    value={useFormFields.address as string}
                    onValChange={handleOnInputChange}
                    validation={useFormValidation.address}
                />

                <InputField
                    placeHolder="بانک / صرافي ایمیل *"
                    name="email"
                    type="text"
                    readonly={false}
