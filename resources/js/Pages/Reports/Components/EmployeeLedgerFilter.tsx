...
function EmployeeLedgerFilter({
    ...
    const [useEmployees, setEmployees] = useState<Array<any>>([]);
    ...
    const loadResources = () => {
        ...
        GetEmployees(function (Employees: Array<any>) {
    ...
    return (
        ...
        >
            ...
            <FormControl size="sm">
                ...
                <Autocomplete
                    size="sm"
                    options={useEmployees}
                    getOptionLabel={(option: any) => option.name}
                    getOptionKey={(option: any) => option.id}
                    value={useFilter.employee}
