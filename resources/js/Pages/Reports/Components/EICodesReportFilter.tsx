...
import { GetEICodesAsItems, LoadCurrencies } from "@/Utils/FetchResources";
...
function EICodesReportFilter({
    ...
    const [useCodes, setCodes] = useState<Array<any>>([]);
    ...
    const loadResources = () => {
        ...
        GetEICodesAsItems(function (Codes: Array<any>) {
            setCodes(Codes);
        });
    };
    ...
    return (
        ...
        >
            ...
            <FormControl size="sm">
                <FormLabel>مصرف / عاید کود</FormLabel>
                <Autocomplete
                    size="sm"
                    options={useCodes}
                    getOptionLabel={(option: any) => option.name}
                    getOptionKey={(option: any) => option.id}
                    value={useFilter.code}
...
export default EICodesReportFilter;
