...
import { getBankLedger } from "@/Utils/FetchReports";
import Printer from "@/Utils/Printer";
import moment from "jalali-moment";
import BankLedgerFilter from "../Components/BankLedgerFilter";
...
function ViewBankLedger() {
    ...
    const LoadRows = (url: string | null | boolean = false) => {
        ...
        if (url)
            ...
            getBankLedger(useFilterOptions, (response: any) =>
                callback(response),
            );
    };
    ...
    const onReportPrint = (): void => {
        ...
        getBankLedger(
            ...
            function (statements: Array<any>) {
                ...
                <li>
                    <span class="i-title">بانک / صرافي</span> :-
                    <span class="i-value"> ${(useFilterOptions.bank as any)?.name || ""}  </span>
                </li>
            </div>
            <div>
                <li>
