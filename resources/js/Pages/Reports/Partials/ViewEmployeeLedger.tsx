...
import { getEmployeeLedger } from "@/Utils/FetchReports";
import Printer from "@/Utils/Printer";
import moment from "jalali-moment";
import EmployeeLedgerFilter from "../Components/EmployeeLedgerFilter";
...
function ViewEmployeeLedger() {
    ...
    const LoadRows = (url: string | null | boolean = false) => {
        ...
        if (url)
            ...
            getEmployeeLedger(useFilterOptions, (response: any) =>
                callback(response),
            );
    };
    ...
    const onReportPrint = (): void => {
        ...
        getEmployeeLedger(
            ...
            function (statements: Array<any>) {
                ...
                <li>
                    <span class="i-title">کارمند</span> :-
                    <span class="i-value"> ${(useFilterOptions.employee as any)?.name || ""}  </span>
                </li>
            </div>
            <div>
                <li>
            ...
            `,
                    Header: function () {
                        return `<tr><th>#</th><th>تاریخ</th><th>معاملي ډول</th><th>تفصیل</th><th>تبادله</th><th>رسیدګي</th><th>بردګي</th><th>بیلانس</th></tr>`;
                    },
                    Data: function () {
                        let _Rows = "";
...
export default ViewEmployeeLedger;
