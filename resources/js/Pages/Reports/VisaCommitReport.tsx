...
import AddVisaCommitting from "./Partials/AddVisaCommitting";
import ViewVisaCommitted from "./Partials/ViewVisaCommitted";
                        ...
                        >
                            ...
                            >
                                <Grid container spacing={2}>
                                    {privileges.visa.reports.committed && (
                                        <AddVisaCommitting />
                                    )}
                                    {privileges.visa.reports.committed && (
                                        <ViewVisaCommitted />
...
export default VisaCommitReport;
